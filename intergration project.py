...
#Main Menu
     ...
     print("2) info")
     print("3) exit")
     userInput1 = int(input("Enter the number of menu option desired: "))
 #play options menu
     if userInput1 == 1:
         ...
         print("4) Hockey")
         print("5) Soccer")
         userInput2 = int(input("Enter the number of sport option desired: "))
 #football is selected   
     ...
     #football question 1           
             ...
             userInput3 = int(input("Enter Answer Here: "))
             if userInput3 == 2:
     ...
     #next question             
             ...
             print("3 ) exit game")
             userInput4 = int(input("enter answer here:"))
     #football question 2
             if userInput4 == 2:
                 main()
             elif userInput4 == 3:
               ...
               print("4) Josh Jacobs")
               userInput5 = int(input("Enter Ansewer Here: "))
               if userInput5 == 3:
     ...
     #next question
               ...
               print("2 ) return to Main Menu")
               print("3 ) exit game")
               userInput6 = int(input("enter answer here:"))
             #end game after question 1          
               if userInput6 == 3:
                 userWishesToContinue = False
                 print("Thank You for playing!")
                 print("score:", score)
         #return to main menu from question 1
               elif userInput6 == 2:
                 main()
               elif userInput6 == 1:
       #football question 3
                 ...
                 print("2) Tom Brady")
                 print("3) Cam Newton")
                 print("4) Aaron Rodgers")
                 userInput7 = int(input("Enter Answer Here:"))
                 if userInput7 == 4:
                 ...
                 print("2) End Game")
                 userInput8 = int(input("Enter Answer Here:" ))
                 if userInput8 == 1:
                   main()
                 elif userInput8 == 2:
                   userWishesToContinue = False
 ...
 #basketball is selected
       ...
       #basketball question 1           
           ...
           userInput9 = int(input("Enter Answer Here:"))
           if userInput9 == 1:
           ...
           print("2) Return to Main Menu")
           print("3) Exit")
           userInput10 = int(input("Enter Answer Here:"))
       ...
       #basketball question 2
             ...
             userInput11 = int(input("Enter Answer Here: "))
             if userInput11 == 3:
             ...
             print("2) Return to Main Menu")
             print("3) Exit")
             userInput12 = int(input("Enter Answer Here:"))
           #exit for basketball question 2
             if userInput12 == 3:
               userWishesToContinue = False
               print("Thank You for playing!")
           #main menu for basketball question 2
             elif userInput12 == 2:
               main()
           #basketball question 3
               ...
               print("3) 18")
               print("4) 46")
               userInput13= int(input("Enter Answer Here:"))
               if userInput13 == 2:
               ...
               print("1) Return to Main Menu")
               print("2) End Game")
               userInput14 = int(input("Enter Answer Here:" ))
           #Main Menu for baskerball question 3
               if userInput14 == 1:
                 main()
...
https://repl.it/repls/NonstopEquatorialDonateware
